...
export default function GFirst() {
    ...
    <div>
      <div className="navbar">
        ...
        <div>
          ...
          <select className="modify-dropdown" onChange={handleModifySelection} defaultValue="">
            <option value="" disabled>Select an action</option> {/* Placeholder option */}
